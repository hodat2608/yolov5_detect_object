...
def program_camera1_FH(model,size,conf):
    ...
    if read_1900 == 1: 
        ...
        if os.listdir(directory1) == []:
            ...
            print('Cam 1 có {} hình'.format(str(len(glob.glob('C:/FH/camera1/*')))))
                ...
                for path1 in glob.glob(filename1 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        for i1 in range(len(model1.names)):
                            ...
                            if values[f'{model1.names[i1]}_OK_1'] == True:
                                ...
                                if len_name1 != int(values[f'{model1.names[i1]}_Num_1']):
                                    ...
                                    if hoan_tat_1 ==2:
                                        window['result_cam1_1'].update(value= 'NG', text_color='red')    
                        ...
                        if myresult1 == 0:
                            ...
                            if hoan_tat_1 ==2:
                                window['result_cam1_1'].update(value= 'OK', text_color='green')
...
def program_camera3_FH(model,size,conf):
    ...
    if read_1904 == 1:
        ...
        if os.listdir(directory3) == []:
            ...
            print('Cam 3 có {} hình'.format(str(len(glob.glob('C:/FH/camera3/*')))))
                ...
                for path3 in glob.glob(filename3 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        for i3 in range(len(model3.names)):
                            ...
                            if values[f'{model3.names[i3]}_OK_3'] == True:
                                ...
                                if len_name3 != int(values[f'{model3.names[i3]}_Num_3']):
                                    ...
                                    if hoan_tat_3 ==2:
                                        window['result_cam3_1'].update(value= 'NG', text_color='red')
                        ...
                        if myresult3 == 0:
                            ...
                            if hoan_tat_3 == 2:
                                window['result_cam3_1'].update(value= 'OK', text_color='green')
    ...
    layout_main = [
        ...
        sg.Frame('',[
            ...
            sg.Frame('',[
                ...
                [sg.Text('',font=('Helvetica',35), justification='center', key='result_cam1',expand_x=True), sg.Text('',font=('Helvetica',35), justification='center', key='result_cam1_1',expand_x=True)],
        ...
        sg.Frame('',[
            ...
            sg.Frame('',[
                ...
                [sg.Text('',font=('Helvetica',35), justification='center', key='result_cam3',expand_x=True),sg.Text('',font=('Helvetica',35), justification='center', key='result_cam3_1',expand_x=True)],
...
image_width_display = int(650)
image_height_display = int(410)
