...
def removefile():
    directory1 = 'D:/FH/camera1/'
    directory2 = 'D:/FH/camera2/'
    directory3 = 'D:/FH/camera3/'
    directory4 = 'D:/FH/camera4/'
...
def program_camera1_FH(model,size,conf):
    p4000 = (4000).to_bytes(2, byteorder='big') + b'\x00'
    read_4000 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4000) # doc thanh ghi 4000
    #print(read_4000)
            ...
            for filename1 in glob.glob('D:/FH/camera1/*'):
                for path1 in glob.glob(filename1 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4000,b'\x00\x00',1)
                        ...
                        #ta = time.time()
                        for i1 in range(len(model1.names)):
                            p_plc_ng = int(values[f'{model1.names[i1]}_PLC_1'])
                            register_ng = (p_plc_ng).to_bytes(2, byteorder='big') + b'\x00'
                            if values[f'{model1.names[i1]}_OK_1'] == True:
                                ...
                                if len_name1 != int(values[f'{model1.names[i1]}_Num_1']):
                                    ...
                                    if values['have_save_NG_1']:
                                        ...
                                        cv2.imwrite('D:/Windows/1/'+ name_folder_ng+'.jpg',img1_save)                                                                                                                                                                                          
                                    myresult1 = 1
                        ...
                        if myresult1 == 0:
                            print('OK')
                            p_plc_ok = int(values['OK_PLC_1'])
                            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(p_plc_ok).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            t2 = time.time() - t1
                            print(t2) 
                        ...
                        # ghi vao D4000 gia tri 10
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,b'\x0F\xA0\x00',b'\x00\x0A',1)
...
def program_camera2_FH(model,size,conf):
    p4002 = (4002).to_bytes(2, byteorder='big') + b'\x00'
    read_4002 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4002) # doc thanh ghi 4002
            ...
            for filename2 in glob.glob('D:/FH/camera2/*'):
                for path2 in glob.glob(filename2 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4002,b'\x00\x00',1)
                        ...
                        #ta = time.time()
                        for i2 in range(len(model2.names)):
                            p_plc_ng = int(values[f'{model2.names[i2]}_PLC_2'])
                            register_ng = (p_plc_ng).to_bytes(2, byteorder='big') + b'\x00'
                            ...
                            if values[f'{model2.names[i2]}_OK_2'] == True:
                                ...
                                if len_name2 != int(values[f'{model2.names[i2]}_Num_2']):
                                    ...
                                    if values['have_save_NG_2']:
                                        ...
                                        cv2.imwrite('D:/Windows/2/'+ name_folder_ng+'.jpg',img2_save)   
                                    myresult2 = 1
                        ...
                        if myresult2 == 0:
                            print('OK')
                            p_plc_ok = int(values['OK_PLC_2'])
                            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(p_plc_ok).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            #fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(3200).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            t2 = time.time() - t1
                            print(t2) 
                        ...
                        # ghi vao D4000 gia tri 10
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,b'\x0F\xA2\x00',b'\x00\x0A',1)
...
def program_camera3_FH(model,size,conf):
    p4004 = (4004).to_bytes(2, byteorder='big') + b'\x00'
    read_4004 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4004) # doc thanh ghi 2004
    if read_4004 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x05':  # gia tri 5
        ...
        if os.listdir(directory3) == []:
            ...
            for filename3 in glob.glob('D:/FH/camera3/*'):
                for path3 in glob.glob(filename3 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4004,b'\x00\x00',1)
                        ...
                        #ta = time.time()
                        for i3 in range(len(model3.names)):
                            p_plc_ng = int(values[f'{model3.names[i3]}_PLC_3'])
                            register_ng = (p_plc_ng).to_bytes(2, byteorder='big') + b'\x00'
                            #register_ng = (3402 + i3*2).to_bytes(2, byteorder='big') + b'\x00'
                            if values[f'{model3.names[i3]}_OK_3'] == True:
                                ...
                                if len_name3 != int(values[f'{model3.names[i3]}_Num_3']):
                                    ...
                                    if values['have_save_NG_3']:
                                        ...
                                        cv2.imwrite('D:/Windows/3/'+ name_folder_ng+'.jpg',img3_save) 
                                    myresult3 = 1
                        ...
                        if myresult3 == 0:
                            print('OK')
                            p_plc_ok = int(values['OK_PLC_3'])
                            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(p_plc_ok).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            #fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(3400).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            t2 = time.time() - t1
                            print(t2) 
                        ...
                        # ghi vao D4000 gia tri 10
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,b'\x0F\xA4\x00',b'\x00\x0A',1)
...
def program_camera4_FH(model,size,conf):
    p4006 = (4006).to_bytes(2, byteorder='big') + b'\x00'
    read_4006 = fins_instance.memory_area_read(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4006) # doc thanh ghi 4006
    if read_4006 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00\x00\x00\x05':  # gia tri 5
        ...
        if os.listdir(directory4) == []:
            ...
            for filename4 in glob.glob('D:/FH/camera4/*'):
                for path4 in glob.glob(filename4 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,p4006,b'\x00\x00',1)
                        ...
                        #ta = time.time()
                        for i4 in range(len(model4.names)):
                            p_plc_ng = int(values[f'{model4.names[i4]}_PLC_4'])
                            register_ng = (p_plc_ng).to_bytes(2, byteorder='big') + b'\x00'
                            #register_ng = (3602 + i4*2).to_bytes(2, byteorder='big') + b'\x00'
                            if values[f'{model4.names[i4]}_OK_4'] == True:
                                ...
                                if len_name4 != int(values[f'{model4.names[i4]}_Num_4']):
                                    ...
                                    if values['have_save_NG_4']:
                                        ...
                                        cv2.imwrite('D:/Windows/4/'+ name_folder_ng+'.jpg',img4_save) 
                                    myresult4 = 1
                        ...
                        if myresult4 == 0:
                            print('OK')
                            p_plc_ok = int(values['OK_PLC_4'])
                            fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(p_plc_ok).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            #fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,(3600).to_bytes(2, byteorder='big') + b'\x00',b'\x00\x01',1)
                            t2 = time.time() - t1
                            print(t2) 
                        ...
                        # ghi vao D4000 gia tri 10
                        fins_instance.memory_area_write(FinsPLCMemoryAreas().DATA_MEMORY_WORD,b'\x0F\xA6\x00',b'\x00\x0A',1)
...
def program_camera1_FH_test(model,size,conf):
...
def program_camera2_FH_test(model,size,conf):
...
def program_camera3_FH_test(model,size,conf):
...
def program_camera4_FH_test(model,size,conf):
    ...
    layout_option2 = [
        ...
        [sg.Frame('',[
            [
                ...
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
                sg.Input('0',size=(8,1),font=('Helvetica',15),key= f'{model2.names[i2]}_PLC_2',text_color='navy',enable_events=True, disabled=False), 
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
    ...
    layout_option4 = [
        ...
        [sg.Frame('',[
            [
                ...
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
                sg.Input('0',size=(8,1),font=('Helvetica',15),key= f'{model4.names[i4]}_PLC_4',text_color='navy',enable_events=True, disabled=False), 
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
                sg.Slider(range=(1,100),default_value=25,orientation='h',size=(30,20),font=('Helvetica',11), key= f'{model4.names[i4]}_Conf_4'),            
            ] for i4 in range(len(model4.names))
        ], relief=sg.RELIEF_FLAT)],
        [sg.Text('  OK',size=(15,1),font=('Helvetica',15), text_color='yellow'),
        sg.Text(' '*230), 
