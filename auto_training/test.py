...
def save_param_camera1(v1,v2,v3,v4,v5,v6,v7):
    line1 = 'exposure1:' + str(v1)
    line2 = 'gain1:' + str(v2)
    line3 = 'red1:' + str(v3)
    line4 = 'greenr1:' + str(v4)
    line5 = 'greenb1:' + str(v5)
    line6 = 'green1:' + str(v6)
    line7 = 'blue1:' + str(v7)
...
def task_camera1(model,size,conf):
    ...
    if temp1==1 and read_2000 == b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00@\x00%':  # gia tri 37
        ...
        or 'tray_bac_truc' in names1 or 'di_vat_duoi' in names1:
            ...
            cv2.imwrite('F:/result/Cam1/NG/' + name_folder_ng + '.jpg',img1_save)
        else:
            print('OK')
            ...
            cv2.imwrite('F:/result/Cam1/OK/' + name_folder_ok  + '.jpg',img1_save)
...
def test_camera1():
    ...
    if read_2000 ==b'\xc0\x00\x02\x00\x19\x00\x00\x01\x00`\x01\x01\x00@\x00%':  # gia tri 37
        ...
        img1_orgin = cv2.resize(img1_orgin,(760,480))
...
def make_window(theme):
    ...
    layout_parameter_camera1 = [
        ...
        [sg.Text('Green',size=(10,1),font=('Helvetica',15), text_color='orange'),
            sg.Input(default_text=list_param_camera1[5],size=(10,1),font=('Helvetica',12),key='green_input1',text_color='navy',disabled=True,enable_events=True),
            sg.Slider(range=(0,255),orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera1[5], key= 'green_slider1', disabled=True,enable_events=True),
        ...
        [sg.Text('Blue',size=(10,1),font=('Helvetica',15), text_color='orange'),
            sg.Input(default_text=list_param_camera1[6],size=(10,1),font=('Helvetica',12),key='blue_input1',text_color='navy',disabled=True,enable_events=True),
            sg.Slider(range=(0,255),orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera1[6], key= 'blue_slider1', disabled=True,enable_events=True),
...
try:
    while True:
        ...
        if event == 'save_param_camera1':
            ...
            save_param_camera1(values['exposure_slider1'],values['gain_slider1'],values['red_slider1'],values['greenr_slider1'],values['greenb_slider1'],values['green_slider1'],values['blue_slider1'])
