...
try:
    while True:
                    ...
                    if row1_a == '1':
                        for item in range(len(model1.names)):
                            if int(row1_b) == item:
                                ...
                                window['PLC_OK_1'].update(value=str(row[25]))
                    ...
                    if row1_a == '2':
                        for item in range(len(model2.names)):
                            if int(row1_b) == item:
                                ...
                                window['PLC_OK_2'].update(value=str(row[25]))
                    if row1_a == '3':
                        for item in range(len(model3.names)):
                            if int(row1_b) == item:
                                ...
                                window['PLC_OK_3'].update(value=str(row[25]))
        ...
        if len(glob.glob(r'C:\Users\Administrator\Desktop\vu\t\*')) == 4:
            cnt=0
            for i in glob.glob(r'C:\Users\Administrator\Desktop\vu\t\*'):
                if cnt %2 !=0:
                    program_camera2_FH(model=model2,size= 416,conf= values['conf_thres2']/100)
                else:
                    program_camera2_FH(model=model3,size= 416,conf= values['conf_thres2']/100)
                cnt+=1
