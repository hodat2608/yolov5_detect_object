...
def test_pattern1(model,size,conf):
...
def test_pattern2(model,size,conf):
...
def make_window(theme):
    ...
    layout_option1 = [
        ...
        [sg.Frame('',[
            ...
            sg.Text('Group',size=(11,1),font=('Helvetica',15), text_color='red')],
        ], relief=sg.RELIEF_FLAT)],
        [sg.Frame('',[
            [
                ...
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
                sg.Input('1',size=(8,1),font=('Helvetica',15),key= f'{model1.names[i1]}_Group_2',text_color='navy',enable_events=True, disabled=True),
            ] for i1 in range(len(model1.names))
        ], relief=sg.RELIEF_FLAT)],
        [sg.Text(' ')],
    ...
    layout_option2 = [
        ...
        [sg.Frame('',[
            [
                ...
                sg.Text('',size=(2,1),font=('Helvetica',15), text_color='red'), 
                sg.Input('1',size=(8,1),font=('Helvetica',15),key= f'{model2.names[i2]}_Group_2',text_color='navy',enable_events=True, disabled=True),
            ] for i2 in range(len(model2.names))
        ], relief=sg.RELIEF_FLAT)],
        [sg.Text(' ')],
...
try:
    while True:
        ...
        #test_pattern1(model=model1,size= 416,conf= values['conf_thres1']/100)
        #test_pattern2(model=model2,size= 416,conf= values['conf_thres2']/100)
