...
def make_window(theme):
    ...
    layout_option1 = [
        ...
        [   
            ...
            sg.Frame('',[
                [sg.FileBrowse(file_types= file_weights, size=(15,1), font=('Helvetica',10),key= 'file_browse1',enable_events=True, disabled=True)]
    ...
    layout_option2 = [
        ...
        [sg.Frame('',[
            ...
            sg.Frame('',[
                [sg.FileBrowse(file_types= file_weights, size=(15,1), font=('Helvetica',10),key= 'file_browse2',enable_events=True, disabled=True)]
            ], relief= sg.RELIEF_FLAT),],
...
try:
    while True:
        ...
        # if event == 'location_weights1':
        #     ROOT_PATH = values['location_weights1']
        #     namesmodel = [f for f in os.listdir(ROOT_PATH) if f.endswith('.pt')]
        #     window['file_weights1'].update(values=namesmodel)
