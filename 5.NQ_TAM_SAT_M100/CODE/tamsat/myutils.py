...
def excel_hangmuc(plc_name, register,ngaydem):
    if read_plc(plc_name,register) == 1:
        ...
        HomNay.merge_cells('A1:BG1')
        HomNay.merge_cells('A2:A3')
        HomNay.merge_cells('B2:B3')
        HomNay.merge_cells('C2:BG2')
        #HomNay.unmerge_cells('A2:D2')
        HomNay['A1'] = 'DỮ LIỆU PHẾ PHẨM HẠNG MỤC LINE 86'
        ...
        HomNay['D3'] = 'Bạc trục c1'
        HomNay['E3'] = 'Đế vỏ nhỏ c1'
        HomNay['F3'] = 'Đệm + Tay chổi c1'
        HomNay['G3'] = 'Khoảng cách chổi c1'
        HomNay['H3'] = 'Khoảng cách rộng c1'
        HomNay['I3'] = 'Khoảng cách hẹp c1'
        HomNay['J3'] = 'Chấu điện c1'

        HomNay['K3'] = 'Bạc trục c2'
        HomNay['L3'] = 'Đế vỏ nhỏ c2'
        HomNay['M3'] = 'Đệm + Tay chổi c2'
        HomNay['N3'] = 'Khoảng cách chổi c2'
        HomNay['O3'] = 'Khoảng cách rộng c2'
        HomNay['P3'] = 'Khoảng cách hẹp c2'
        HomNay['Q3'] = 'Chấu điện c2'

        HomNay['R3'] = 'Bạc trục c3'
        HomNay['S3'] = 'Đế vỏ nhỏ c3'
        HomNay['T3'] = 'Đệm + Tay chổi c3'
        HomNay['U3'] = 'Khoảng cách chổi c3'
        HomNay['V3'] = 'Khoảng cách rộng c3'
        HomNay['W3'] = 'Khoảng cách hẹp c3'
        HomNay['X3'] = 'Chấu điện c3'

        HomNay['Y3'] = 'Bạc trục c4'
        HomNay['Z3'] = 'Đế vỏ nhỏ c4'
        HomNay['AA3'] = 'Đệm + Tay chổi c4'
        HomNay['AB3'] = 'Khoảng cách chổi c4'
        HomNay['AC3'] = 'Khoảng cách rộng c4'
        HomNay['AD3'] = 'Khoảng cách hẹp c4'
        HomNay['AE3'] = 'Chấu điện c4'

        HomNay['AF3'] = 'Bạc trục c5'
        HomNay['AG3'] = 'Đế vỏ nhỏ c5'
        HomNay['AH3'] = 'Đệm + Tay chổi c5'
        HomNay['AI3'] = 'Khoảng cách chổi c5'
        HomNay['AJ3'] = 'Khoảng cách rộng c5'
        HomNay['AK3'] = 'Khoảng cách hẹp c5'
        HomNay['AL3'] = 'Chấu điện c5'

        HomNay['AM3'] = 'Bạc trục c6'
        HomNay['AN3'] = 'Đế vỏ nhỏ c6'
        HomNay['AO3'] = 'Đệm + Tay chổi c6'
        HomNay['AP3'] = 'Khoảng cách chổi c6'
        HomNay['AQ3'] = 'Khoảng cách rộng c6'
        HomNay['AR3'] = 'Khoảng cách hẹp c6'
        HomNay['AS3'] = 'Chấu điện c6'

        HomNay['AT3'] = 'Bạc trục c7'
        HomNay['AU3'] = 'Đế vỏ nhỏ c7'
        HomNay['AV3'] = 'Đệm + Tay chổi c7'
        HomNay['AW3'] = 'Khoảng cách chổi c7'
        HomNay['AX3'] = 'Khoảng cách rộng c7'
        HomNay['AY3'] = 'Khoảng cách hẹp c7'
        HomNay['AZ3'] = 'Chấu điện c7'

        HomNay['BA3'] = 'Tổng số lượng PP c1'
        HomNay['BB3'] = 'Tổng số lượng PP c2'
        HomNay['BC3'] = 'Tổng số lượng PP c3'
        HomNay['BD3'] = 'Tổng số lượng PP c4'
        HomNay['BE3'] = 'Tổng số lượng PP c5'
        HomNay['BF3'] = 'Tổng số lượng PP c6'
        HomNay['BG3'] = 'Tổng số lượng PP c7'
    

        #HomNay['M3'] = 'Tổng số lượng PP'

        for i in range(67,67+60):
        ...
        if ngaydem =='Ngay':
            ...
            wb.save(f"excel/{mydate}_Ngay_hangmuc.xlsx")
            try:
                shutil.copy(f"excel/{mydate}_Ngay_hangmuc.xlsx", f"C:/excel/{mydate}_Ngay_hangmuc.xlsx")
            except:
                pass

        elif ngaydem == 'Dem':
            wb.save(f"excel/{mydate}_Dem_hangmuc.xlsx")
            try:
                shutil.copy(f"excel/{mydate}_Dem_hangmuc.xlsx", f"C:/excel/{mydate}_Dem_hangmuc.xlsx")
            except:
                pass
...
def excel_ray(plc_name, register, ngaydem):
    if read_plc(plc_name,register) == 1:
        ...
        HomNay.merge_cells('A1:J1')
        HomNay.merge_cells('A2:A3')
        HomNay.merge_cells('B2:B3')
        HomNay.merge_cells('C2:J2')
        #HomNay.unmerge_cells('A2:D2')
        HomNay['A1'] = 'DỮ LIỆU PHẾ PHẨM RAY LINE 86'
        HomNay['A1'].alignment = Alignment(horizontal='center')
        HomNay['A1'].font = Font(name= 'Calibri', size=20)
        ...
        HomNay['C2'].alignment = Alignment(horizontal='center')
        HomNay['C2'].font = Font(name= 'Calibri', size=12)
        HomNay['C3'] = 'Ray bạc trục'
        HomNay['D3'] = 'Ray đế vỏ nhỏ'
        HomNay['E3'] = 'Ray đệm + tay chổi'
        HomNay['F3'] = 'Ray khoảng cách chổi'
        HomNay['G3'] = 'Ray khoảng cách rộng'
        HomNay['H3'] = 'Ray khoảng cách hẹp'
        HomNay['I3'] = 'Ray chấu điện'
        HomNay['J3'] = 'Ray phế phẩm khác'
        # HomNay['K3'] = 'Ray 4 Cam 2'
        ...
        if ngaydem =='Ngay':
            ...
            wb.save(f"excel/{mydate}_Ngay_ray.xlsx")
            try:
                shutil.copy(f"excel/{mydate}_Ngay_ray.xlsx", f"C:/excel/{mydate}_Ngay_ray.xlsx")
            except:
                pass

        elif ngaydem == 'Dem':
            wb.save(f"excel/{mydate}_Dem_ray.xlsx")
            try:
                shutil.copy(f"excel/{mydate}_Dem_ray.xlsx", f"C:/excel/{mydate}_Dem_ray.xlsx")
            except:
                pass
...
def excel_handle_pphangmuc(plc_name, register):
    if read_plc(plc_name,register) == 1:
        ...
        if 7<= hour <=18:
            if not os.path.isfile(f"excel/{mydate}_Ngay_hangmuc.xlsx"):
                excel_hangmuc(plc_name, register,'Ngay')
            wb = openpyxl.load_workbook(f"excel/{mydate}_Ngay_hangmuc.xlsx")

        if 19 <= hour <= 23:
            if not os.path.isfile(f"excel/{mydate}_Dem_hangmuc.xlsx"):
                excel_hangmuc(plc_name, register,'Dem')
            wb = openpyxl.load_workbook(f"excel/{mydate}_Dem_hangmuc.xlsx")

        if 0 <= hour <= 6:
            Previous_Date = datetime.datetime.today() - datetime.timedelta(days=1)
            Previous_Date = Previous_Date.strftime("%Y_%m_%d")
            if not os.path.isfile(f"excel/{Previous_Date}_Dem_hangmuc.xlsx"):
                excel_hangmuc(plc_name, register,'Dem')

            wb = openpyxl.load_workbook(f"excel/{Previous_Date}_Dem_hangmuc.xlsx")
        ...
        if 7<= hour <=18:
            ...
            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{mydate}_Ngay_hangmuc.xlsx")
                ...
                wb2 = openpyxl.load_workbook("C:/excel/Now_hangmuc.xlsx")
                ws2 = wb2.active
                ...
                wb2.save("C:/excel/Now_hangmuc.xlsx")
        ...
        if 19 <= hour <= 23:
            ...
            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{mydate}_Dem_hangmuc.xlsx")
        ...
        if 0 <= hour <= 6:
            Previous_Date = datetime.datetime.today() - datetime.timedelta(days=1)
            Previous_Date = Previous_Date.strftime("%Y_%m_%d")
            wb.save(f"excel/{Previous_Date}_Dem_hangmuc.xlsx")
            try:
                shutil.copy(f"excel/{Previous_Date}_Dem_hangmuc.xlsx", f"C:/excel/{Previous_Date}_Dem_hangmuc.xlsx")
            except:
                pass

            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{Previous_Date}_Dem_hangmuc.xlsx")
...
def excel_handle_ppray(plc_name, register):
    if read_plc(plc_name,register) == 1:
        ...
        if 7<= hour <=18:
            if not os.path.isfile(f"excel/{mydate}_Ngay_ray.xlsx"):
                excel_ray(plc_name, register,'Ngay')
            wb = openpyxl.load_workbook(f"excel/{mydate}_Ngay_ray.xlsx")

        if 19 <= hour <= 23:
            if not os.path.isfile(f"excel/{mydate}_Dem_ray.xlsx"):
                excel_ray(plc_name, register,'Dem')
            wb = openpyxl.load_workbook(f"excel/{mydate}_Dem_ray.xlsx")
        ...
        if 0 <= hour <= 6:
            ...
            wb = openpyxl.load_workbook(f"excel/{Previous_Date}_Dem_ray.xlsx")


        ws = wb.active
        col1 = d1
        col2 = t1
        col3 = int(read_plc(plc_name,5000))
        col4 = int(read_plc(plc_name,5002))
        col5 = int(read_plc(plc_name,5004))
        col6 = int(read_plc(plc_name,5006))
        col7 = int(read_plc(plc_name,5116))
        col8 = int(read_plc(plc_name,5118))
        col9 = int(read_plc(plc_name,5008))
        col10 = int(read_plc(plc_name,5010))
        # col11 = int(read_plc(plc_name,7006))
        ...
        ws.append([col1, col2,col3, col4,col5, col6,col7, col8,col9, col10])
        ...
        if 7<= hour <=18:
            ...
            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{mydate}_Ngay_ray.xlsx")
                ...
                wb2 = openpyxl.load_workbook("C:/excel/Now_ray.xlsx")
                ws2 = wb2.active
        ...
        if 19 <= hour <= 23:
            ...
            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{mydate}_Dem_ray.xlsx")
        ...
        if 0 <= hour <= 6:
            Previous_Date = datetime.datetime.today() - datetime.timedelta(days=1)
            Previous_Date = Previous_Date.strftime("%Y_%m_%d")
            wb.save(f"excel/{Previous_Date}_Dem_ray.xlsx")
            try:
                shutil.copy(f"excel/{Previous_Date}_Dem_ray.xlsx", f"C:/excel/{Previous_Date}_Dem_ray.xlsx")
            except:
                pass

            try:
                wb1 = openpyxl.load_workbook(f"C:/excel/{Previous_Date}_Dem_ray.xlsx")
